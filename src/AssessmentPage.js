...
const AssessmentPage = ({ assessmentData }) => {
  ...
  const handleSubmit = () => {
    // Handle saving user responses
    console.log('User responses:', userResponses)
    // Redirect or perform other actions after assessment completion if needed
  }
        ...
        {!assessmentStarted ? (
          <div className='flex flex-col items-center'>
            ...
            <input
              ...
              style={{ color: 'black' }} // Add this line to set text color to black
            />
            <button
